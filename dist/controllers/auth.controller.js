...
import { hashPassword, verifyPassword, clearSessionCookie, addAccountToSession, switchAccountInSession, removeAccountFromSession, revokeAllUserSessions, isSessionRevoked, getMultiAccountSession, } from '../services/auth.service.js';
...
import { sendSuccess, sendCreated, sendBadRequest, sendUnauthorized, sendConflict, sendInternalError, sanitizeUser, } from '../utils/http.js';
// Etapa 1: Validar correo y contraseña
export async function validateStage1(req, res) {
    try {
...
export async function forgotPassword(req, res) {
    try {
        ...
        sendInternalError(res, 'Error al procesar solicitud de recuperación de contraseña', error, 'Ha ocurrido un error inesperado al procesar la solicitud. Por favor intenta más tarde.');
    }
}
/**
...
export async function resetPassword(req, res) {
    try {
        ...
        if (!tokenResult.success || !tokenResult.userId) {
            ...
            sendBadRequest(res, tokenResult.error || 'El enlace de recuperación ha expirado o ya ha sido utilizado.');
            return;
        }
        ...
        sendInternalError(res, 'Error al restablecer la contraseña', error, 'Ha ocurrido un error inesperado al actualizar tu contraseña. Por favor intenta más tarde.');
    }
}
