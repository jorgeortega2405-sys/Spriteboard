import { API_ROUTES, postApi } from './api.service.js';
...
export function initTheme(initialPrefs: { high_contrast?: boolean; reduce_motion?: boolean; theme?: string } | null = null): void {
