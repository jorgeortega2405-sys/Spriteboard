...
export const DEFAULT_ROLE_PERMISSIONS: Record<string, string[]> = {
  AUDITOR: ['dashboard:read', 'users:read', 'ads:read', 'support:read', 'internal_tickets:read', 'backups:read', 'logs:read', 'billing:read', 'analytics:read', 'compliance:read', 'workflows:read', 'roles:read', 'system:read', 'hr:read'],
  ...
  DESIGNER: ['templates:create', 'templates:publish', 'templates:read', 'designer:dashboard', 'designer:onboard', 'designer:payouts'],
