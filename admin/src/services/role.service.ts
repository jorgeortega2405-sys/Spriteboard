...
export const DEFAULT_ROLE_PERMISSIONS: Record<string, string[]> = {
  AUDITOR: ['dashboard:read', 'users:read', 'ads:read', 'support:read', 'internal_tickets:read', 'backups:read', 'logs:read', 'billing:read', 'analytics:read', 'compliance:read', 'workflows:read', 'roles:read', 'system:read'],
  ...
  FINANCE_ADMIN: ['dashboard:read', 'billing:read', 'billing:export', 'billing:manage', 'ads:read', 'ads:manage', 'users:read', 'system:read'],
  IAM_ADMIN: ['dashboard:read', 'users:read', 'users:manage', 'roles:read', 'roles:manage', 'logs:read'],
  ...
  OPERATIONS_MANAGER: ['dashboard:read', 'ads:read', 'ads:manage', 'users:read', 'support:read', 'support:manage', 'internal_tickets:read', 'internal_tickets:create', 'internal_tickets:manage', 'workflows:read'],
  PLATFORM_ADMIN: ['*'],
  PRIVACY_ADMIN: ['users:read', 'compliance:read', 'compliance:manage', 'logs:read'],
  READ_ONLY_ADMIN: ['dashboard:read', 'users:read', 'internal_tickets:read', 'logs:read', 'backups:read', 'system:read'],
  ...
  SECURITY_ADMIN: ['dashboard:read', 'users:read', 'users:manage', 'users:sanctions', 'roles:read', 'roles:manage', 'logs:read', 'system:read', 'system:manage', 'internal_tickets:create'],
  SENIOR_ENGINEER: ['internal_tickets:read', 'internal_tickets:create', 'internal_tickets:manage', 'logs:read', 'backups:read', 'workflows:read'],
  SRE: ['dashboard:read', 'internal_tickets:read', 'internal_tickets:create', 'internal_tickets:manage', 'logs:read', 'backups:read', 'workflows:read', 'workflows:manage', 'system:read', 'system:manage'],
  SUPER_ADMIN: ['*'],
