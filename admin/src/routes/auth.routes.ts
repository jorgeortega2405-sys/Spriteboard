...
import { firstLoginChangePassword, googleAuth, googleAuthCallback, login, logout, logoutAll, me, switchAccount, verify2FALogin } from '../controllers/auth.controller.js';
...
router.post('/login/first-change-password', loginLimiter, firstLoginChangePassword);
