...
export const GOOGLE_DRIVE_API_KEY = (import.meta as any).env?.VITE_GOOGLE_API_KEY || (import.meta as any).env?.VITE_GOOGLE_DRIVE_API_KEY || 'AIzaSyBFsBn3Hi6CLH904UXGgOHP-rXORvs1-Us';
export const GOOGLE_DRIVE_CLIENT_ID = (import.meta as any).env?.VITE_GOOGLE_CLIENT_ID || '899980904040-n9foado9rou3etjr8d5ouikpa1ivaml2.apps.googleusercontent.com';
