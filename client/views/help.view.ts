...
const HELP_SECTIONS_DATA: Record<string, HelpSectionInfo> = {
  terms: {
    titleKey: 'help_center.terms_title',
    defaultTitle: 'Términos y condiciones',
    subtitleKey: 'help_center.terms_subtitle',
    defaultSubtitle:
      'Condiciones generales de uso, derechos y responsabilidades en el uso de la plataforma Spriteboard.',
  },
  privacy: {
    ...
    defaultSubtitle:
      'Información sobre la recopilación, almacenamiento y protección rigurosa de tus datos personales.',
  },
  cookies: {
    ...
    defaultSubtitle:
      'Detalle de las cookies técnicas, analíticas y de preferencias empleadas en la aplicación.',
  },
  legal_notice: {
    ...
    defaultSubtitle:
      'Identificación corporativa, titularidad legal del servicio y marco normativo aplicable.',
  },
  billing: {
    ...
    defaultSubtitle:
      'Condiciones de contratación recurrente, procesamiento seguro de pagos, impuestos y cancelaciones.',
  },
  support: {
    ...
    defaultSubtitle:
      'Centro de asistencia, resolución de dudas frecuentes y recepción de comentarios para mejorar la plataforma.',
  },
};
...
export async function createHelpView(sectionKey = 'terms'): Promise<HTMLElement> {
  ...
  const subtitleEl = container.querySelector<HTMLElement>('[data-ref="help-subtitle"]');
