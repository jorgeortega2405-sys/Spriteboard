...
import { StagePageItem, StageProject } from '../../types/stage.types.js';
...
export interface StageCollaborationCallbacks {
  ...
  onRemoteFullUpdate: (data: StageProject | { activePageId?: string; background?: { color: string; dotColor?: string; type: BackgroundType }; elements?: BoardElement[]; height?: number; pages?: StagePageItem[]; width?: number }) => void;
  onRemoteReorderElements: (elements: BoardElement[], slideId?: string) => void;
  onRemoteSlideAdd: (slide: StagePageItem, insertIndex?: number) => void;
...
export type PresentationCollaborationCallbacks = StageCollaborationCallbacks;

export class StageCollaborationManager {
  ...
  public broadcastSlideAdd(slide: StagePageItem, insertIndex?: number): void {
  ...
  public broadcastFullUpdate(data: StageProject | { activePageId?: string; background?: { color: string; dotColor?: string; type: BackgroundType }; elements?: BoardElement[]; height?: number; pages?: StagePageItem[]; width?: number }, targetConnId?: string): void {
...
export const PresentationCollaborationManager = StageCollaborationManager;
